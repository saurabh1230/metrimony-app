          ...
          child: Padding(
            ...
            child: Column(
              ...
              const   SizedBox.shrink(),
                ...
                //                 atributeReligion:
                //                     "5 ft 4 in  • ${StringUtils.capitalize(matches[i].profile!.basicInfo?.religion ?? "")}",
                //                 profession: "Software Engineer",
                //                 Location:
                //                     "${matches[i].profile?.basicInfo?.presentAddress!.state ?? ""} ${matches[i].profile?.basicInfo?.presentAddress!.country ?? ""}",
