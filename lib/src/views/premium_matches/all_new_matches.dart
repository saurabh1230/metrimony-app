...
// //         // print(matchesControl.matchesList!.length);
// //         return  isLoading
// //             ? const ShimmerWidget()
// //             : Padding(
...
// //     // getMatches();
// //     print("dfdsn");
// //     Get.find<MatchesController>().getMatchesList('3');
// //     print("dfdsn");
// //   }
// //
// //
...
// //                   userName: matchesControl.matchesList![i].firstname == null && matchesControl.matchesList![i].lastname == null
// //                       ? "user"
// //                       : '${StringUtils.capitalize(matchesControl.matchesList![i].firstname ?? '')} ${StringUtils.capitalize(matchesControl.matchesList![i].lastname ?? '')}',
// //                   atributeReligion: "Religion: ${matchesControl.matchesList![i].basicInfo?.religion}",
// //                   profession: "",
...
// //                           isLoadingList[i] = true;
// //                         });
// //                         sendRequestApi(memberId:matchesControl.matchesList![i].id.toString()).then((value) {
// //                           if (value['status'] == true) {
// //                             setState(() {
// //                               isLoadingList[i] = false;
// //                             });
...
// //                       },
// //                       title: "Connect Now"),
// //                   height:"${matchesControl.matchesList?[i].physicalAttributes?.height ??''} ft",
// //                   bookmark: GestureDetector(
// //                     onTap: () {
// //                       setState(() {
// //                         // like[i] = !like[i];
