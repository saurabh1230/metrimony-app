...
//   String? message;
//
//   MatchesModel({this.status, this.data, this.message});
//
...
// }
//
// class PartnerExpectationMatchMdl {
//   int? id;
//   int? userId;
//   String? generalRequirement;
//   String? country;
...
//         this.maritialStatus});
//
//   PartnerExpectationMatchMdl.fromJson(Map<String, dynamic> json) {
//     id = json['id'];
//     userId = json['user_id'];
//     generalRequirement = json['general_requirement'];
//     country = json['country'];
