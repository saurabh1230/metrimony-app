...
class OtherBasicInfo {
  ...
  OtherBasicInfo.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
    userType = json['user_type'];
    gender = json['gender'];
...
class OtherPresentAddress {
  String? country;
  String? state;
  String? zip;
  String? city;

  OtherPresentAddress({this.country, this.state, this.zip, this.city});

  OtherPresentAddress.fromJson(Map<String, dynamic> json) {
    country = json['country'];
    state = json['state'];
    zip = json['zip'];
    city = json['city'];
...
class OtherCareerInfo {
  ...
  OtherCareerInfo.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
    position = json['position'];
    from = json['from'];
...
class OtherPartnerExpectation {
  ...
  OtherPartnerExpectation.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
    generalRequirement = json['general_requirement'];
    country = json['country'];
